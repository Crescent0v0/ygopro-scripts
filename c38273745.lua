...
function c38273745.tg1(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local lastsel,alrsel = e:GetLabel()
	...
	local b3=o3 Duel.IsExistingTarget(Card.IsAbleToRemove,tp,0,LOCATION_GRAVE,1,nil)
	if chk==0 then return b1 or b2 or b3 end
	local op=aux.SelectFromOptions(tp,
		{b1,aux.Stringid(38273745,1)},
		{b2,aux.Stringid(38273745,2)},
		{b3,aux.Stringid(38273745,3)})
	e:SetLabel(op,alrsel and alrsel|(1<<op) or 1<<op)
	if op==1 then
